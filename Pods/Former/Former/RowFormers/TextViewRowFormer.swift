...
: BaseRowFormer<T>, Formable where T: TextViewFormableRow {
    ...
    fileprivate final func updatePlaceholderColor(_ text: String?) {
        if attributedPlaceholder == nil {
            placeholderLabel?.textColor = (text?.isEmpty ?? true) ? UIColor(red: 0, green: 0, blue: 0.098 / 255, alpha: 0.22) : .clear
        } else {
